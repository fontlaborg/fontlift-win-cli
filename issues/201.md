...
| `cleanup` | `c` | Removes broken registry entries and clears system font caches (requires admin) | 3\. **Troubleshooting Section:** A note will be added suggesting `fontlift cleanup` as a potential fix for font rendering issues.
